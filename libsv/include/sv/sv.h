 ...
 * allocated and if not, it tries to allocate them. After than
 ...
 * 
 * The first control group start with the ID 1 and they change
 * how the API behaves (e.g. GetImage() timeout). Their IDs are
 * available in the enums.sh file and use the "SV_API" namespace.
 * 
 * The second control group start with the ID 10 and they change
